...
import com.movtery.zalithlauncher.feature.benchmark.BenchmarkRunDialog
...
class LauncherSettingsFragment() : AbstractSettingsFragment(R.layout.settings_fragment_launcher, SettingCategory.LAUNCHER) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        BaseSettingsWrapper(
            context,
            binding.runBenchmarkLayout
        ) {
            BenchmarkRunDialog(context).show()
        }

        SwitchSettingsWrapper(
            context,
            AllSettings.benchmarkAutoApply,
            binding.benchmarkAutoApplyLayout,
            binding.benchmarkAutoApply
        )

        SwitchSettingsWrapper(
            context,
            AllSettings.benchmarkEnableConflictCheck,
            binding.benchmarkEnableConflictCheckLayout,
            binding.benchmarkEnableConflictCheck
        )
    }
