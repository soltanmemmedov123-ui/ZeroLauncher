...
public class MinecraftAccount {
    ...
    private static final java.util.concurrent.ConcurrentHashMap<String, MinecraftAccount> sCache = new java.util.concurrent.ConcurrentHashMap<>();
